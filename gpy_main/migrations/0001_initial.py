# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-16 21:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.CharField(default=uuid.UUID('6151b1c9-b72b-402b-9d3f-74a4d01c6aa6'), max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='UlxUserData',
        ...
        migrations.AddField(
            ...
            name='gpy_profile',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='gpy_main.GpyProfile'),
        ),
        migrations.AddField(
            model_name='steamuser',
            name='groups',
