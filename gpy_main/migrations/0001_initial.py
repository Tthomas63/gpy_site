    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.CharField(default='user', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.CharField(default=uuid.UUID('657eaf70-94c6-4a60-9534-0cec249ccebb'), max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='UlxUserData',
        ...
        migrations.AddField(
            model_name='steamuser',
            name='user_gpy_profile',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='gpy_main.SteamUserGpyProfile'),
        ),
        migrations.AddField(
            model_name='steamuser',
